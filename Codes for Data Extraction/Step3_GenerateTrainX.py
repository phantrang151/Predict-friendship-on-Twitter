...
dev_pos_25K.to_csv('train_pos_x_100K.csv',header=False,index=False)
...
dev_neg_x_25K.to_csv('train_neg_x_100K.csv',header=False, index=False)

#Combin the positive and negtive together
dev_x_50K = dev_neg_x_25K.append(dev_pos_25K,ignore_index=True)
dev_x_50K.to_csv('train_x_200K.csv',header=False,index=False)
