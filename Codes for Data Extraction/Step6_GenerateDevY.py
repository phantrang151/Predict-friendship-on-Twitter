...
positive_frame_y.to_csv("dev_pos_y_25K.csv", encoding='utf-8', index=False, header=None)
...
negative_frame_y.to_csv("dev_neg_y_25K.csv", encoding='utf-8', index=False, header=None)
...
train_y_frame.to_csv("dev_y_50K.csv", encoding='utf-8', index=False, header=None)
