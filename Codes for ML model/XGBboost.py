...
drop_list = ['jaccard', "preferential_attachment", "adar",'in_degree', 'follows_back', 'out_degree', 'shortest_path']
...
results.to_csv("./submissions/submission_XGBoost_RA_1000.csv",index=False)
